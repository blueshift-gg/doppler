...
npx @blueshift-gg/doppler-generator init

# 2. Compile bytecode, manifest.json, and optional SDKs
npx @blueshift-gg/doppler-generator generate ./payload.ts

# 3. Deploy to a cluster
npx @blueshift-gg/doppler-generator deploy ./doppler.so \
